		...
		<footer>
			<div className="footer_start">
				...
				<div className="footer_privacy">
					<div className="inner_privacy">
						...
						<span className="pri_content">
							...
							<a href="/privacy">https://bookmyshow.com/privacy</a> governing
							your access to Bookmyshow and provision of services by Bookmyshow
							to you. If you do not accept terms mentioned in the{" "}
							<a href="/privacy">Privacy Policy</a>, you must not share any of
							your personal information and immediately exit Bookmyshow
						</span>
					</div>
				</div>
				...
				<div className="end_main">
					...
					{/* </div>
					<div> */}
					<a href="https://www.linkedin.com/company/bookmyshow/" class="end">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							viewBox="-1 -1 102 102"
							id="icon-resend"
