          ...
          <footer>
            <div className="footer_start">
              ...
              <div className="footer_privacy">
                <div className="inner_privacy">
                  <h4 className="privacy" style={{ fontSize: "12px" }}>
                    Privacy Note
                  </h4>
                  <span className="pri_content">
                    By using www.bookmyshow.com(our website), you are fully
                    accepting the Privacy Policy available at{" "}
                    <a href="/privacy">https://bookmyshow.com/privacy</a>{" "}
                    governing your access to Bookmyshow and provision of
                    services by Bookmyshow to you. If you do not accept terms
                    mentioned in the <a href="/privacy">Privacy Policy</a>, you
                    must not share any of your personal information and
                    immediately exit Bookmyshow
                  </span>
                </div>
              </div>

              <div className="hut_main">
                <div className="hut_text">
                  <img
                    alt="hut"
                    src="https://in.bmscdn.com/webin/common/icons/hut.svg"
                    class="hut"
                  />
                  <span className="hut_space">
                    List your Show Got a show, event, activity or a great
                    experience? Partner with us &amp; get listed on BookMyShow
                    <span className="button_hut">
                      <button class="ui negative button">Contact Us!</button>
                    </span>
                  </span>
                </div>
              </div>
              <div className="footer4">
                <div className="footer4_text">
                  <div className="footer_opt1">
                    <a href="https://support.bookmyshow.com/support/home?regionCode=NCR">
                      <svg
                  ...
                  <div className="footer_opt1">
                    ...
                    {/* <span>24/7 CUSTOMER CARE</span>
						<span>RESEND CONFIRMATION BOOKING</span> */}
                    <span>NEWSLETTER</span>
                  </div>
                </div>
              </div>
              <div className="footer_last">
                <div
                  ...
                  style={{ height: "1px", color: "white" }}
                >
                  ------------------------------
                </div>
                <a href="/bookmyshow" className="logoo">
                  <img
                    alt="bookmyshow"
              ...
              <div className="end_main">
                <a href="https://www.facebook.com/BookMyShowIN" class="end">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="-1 -1 98 98"
                    id="icon-resend"
                ...
                {/* </div> */}
                {/* <div> */}
                <a href="https://www.instagram.com/bookmyshowin/" class="end">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="-1 -1 102 102"
                    id="icon-resend"
                ...
                {/* </div>
					<div> */}
                {/* <a
						href="https://www.pinterest.com/bookmyshow/"
						class="end"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
                ...
                {/* </div>
					<div> */}
                <a
                  href="https://www.linkedin.com/company/bookmyshow/"
                  class="end"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
